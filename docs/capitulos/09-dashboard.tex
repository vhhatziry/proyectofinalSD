...
de los nodos en línea para indicar si el invariante se conserva (cada total
proviene del snapshot atomico de \codigo{totalCents()}, así que el sello no
parpadea por lecturas rotas bajo carga), y una tarjeta
